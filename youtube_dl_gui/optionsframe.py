...
class TabPanel(wx.Panel):
    ...
    def crt_combobox(self, choices, size=(-1, -1), event_handler=None):
        combobox = ComboBox(self, choices=choices,
                            size=size, style=wx.CB_READONLY)
    ...
    def crt_listbox(self, choices, style=None):
        if style is None:
            ...
            listbox = wx.ListBox(self, choices=choices,
                                 style=style, size=self.LISTBOX_SIZE)
...
class GeneralTab(TabPanel):
    ...
    def _set_layout(self):
        ...
        vertical_sizer.Add(custom_format_sizer, flag=wx.EXPAND |
        ...
        vertical_sizer.Add(self.confirm_deletion_checkbox,
                           flag=wx.LEFT | wx.RIGHT | wx.BOTTOM, border=5)
        vertical_sizer.Add(self.show_completion_popup_checkbox,
                           flag=wx.LEFT | wx.RIGHT | wx.BOTTOM, border=5)
        ...
        vertical_sizer.Add(shutdown_sizer, flag=wx.EXPAND |
                           wx.LEFT | wx.RIGHT | wx.BOTTOM, border=5)
    ...
    def load_options(self):
        self.language_combobox.SetValue(self.LOCALE_NAMES.get(
            self.opt_manager.options["locale_name"], "English"))
...
class FormatsTab(TabPanel):
    AUDIO_QUALITY = twodict(
        [("0", _("high")), ("5", _("mid")), ("9", _("low"))])
    ...
    def _set_layout(self):
        ...
        vertical_sizer.Add(audio_quality_sizer, flag=wx.LEFT |
...
class DownloadsTab(TabPanel):
    ...
    def _set_layout(self):
        ...
        vertical_sizer.Add(self.subtitles_combobox,
                           flag=wx.EXPAND | wx.ALL, border=5)
        vertical_sizer.Add(self.subtitles_lang_listbox, 1,
                           wx.EXPAND | wx.LEFT | wx.RIGHT | wx.BOTTOM, border=5)
        ...
        vertical_sizer.Add(plist_and_fsize_sizer, 1,
                           wx.EXPAND | wx.TOP, border=5)
    ...
    def _build_filesize_sizer(self):
        ...
        border.Add(self.filesize_max_label, (0, 0),
                   (1, 2), wx.ALIGN_CENTER_HORIZONTAL)

        border.Add(self.filesize_max_spinctrl, (1, 0))
        border.Add(self.filesize_max_sizeunit_combobox, (1, 1))

        border.Add(self.filesize_min_label, (2, 0),
                   (1, 2), wx.ALIGN_CENTER_HORIZONTAL)
...
class AdvancedTab(TabPanel):
    ...
    def _set_layout(self):
        ...
        vertical_sizer.Add(retries_sizer, flag=wx.ALIGN_RIGHT |
                           wx.TOP | wx.RIGHT, border=5)
...
class ExtraTab(TabPanel):
    ...
    def _set_layout(self):
        ...
        vertical_sizer.Add(self.cmdline_args_textctrl, 1,
